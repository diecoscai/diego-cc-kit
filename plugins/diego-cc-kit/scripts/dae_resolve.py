...
# upstream path: engineer/scripts/dae_resolve.py. Unmodified — required
# companion module for dae_arch.py's manifest parsing. Local modifications
# (if any) are marked LOCAL: in dae_arch.py, not here.
