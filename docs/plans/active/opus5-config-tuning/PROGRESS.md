...
|---|---|---|---|
| 1 | Scope verification to trust boundaries | diego-cc-kit repo | Not started |
| 2 | Scope implement Phase 3 | diego-cc-kit repo | Not started |
| 3 | Invert delegation, route by effort | diego-cc-kit repo | Not started |
| 4 | Ship plugin (bump → push → update → restart) | diego-cc-kit repo | Not started |
